...
#                                                      16 - 11/03/2025
#------------------------------------------------------------------------------------------------------------------------------------------------#
# Linear Search (O(n)) - return index of first occurrence
# Input: list, target
# Output : index of first occurrence



def fir_occurence(nums: List[int], target: int) -> int:
...
#                                                      17 - 11/03/2025
#------------------------------------------------------------------------------------------------------------------------------------------------#
#Linear Search O(n) - return all indices where the target appears
#Input: list, target
#Output: indices of target

def indices_target(nums: List[int], target: int) -> int: 
    count = []
...
#                                                      18 - 11/03/2025
#------------------------------------------------------------------------------------------------------------------------------------------------#
#Linear Search - Check if list contains any negative numbers
#Input: List
#Output: Boolean

def neg_nums(nums: List[int]) -> bool:
...
#                                                      19 - 11/03/2025
#------------------------------------------------------------------------------------------------------------------------------------------------#
#Return the smallest number in the list (no built ins)
#Input: List
#Output: smallest int


def small_num(nums: List[int]) -> int:
    min_num = nums[0]
    for num in nums:
        if num < min_num:
            min_num = num
...
#                                                      20 - 11/03/2025
#------------------------------------------------------------------------------------------------------------------------------------------------#
#Linear Searh O(n) - Count how many elements are greater than a given value
#Input: List, target
#Output: Count of elemetns greater than target
